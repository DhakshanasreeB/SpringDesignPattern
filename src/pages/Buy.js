...
const BuyPage = () => {
  ...
  console.log('Filtered Properties:', filteredProperties); // Debug log for filtered properties
  ...
  console.log('Sorted Properties:', sortedProperties); // Debug log for sorted properties
